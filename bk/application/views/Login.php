...
<body class="hold-transition login-page" style="background-image: url('https://i.ibb.co/nDdcb2R/bg2.jpg');" >
  
<div class="login-box" >
  <div class="login-logo" style="color: #fff;" >
    <div >
        <h2> Monitoring Pelanggaran Siswa </h2>
    </div>
    <img width="10%" src="<?php echo base_url();?>assets/HomePage/images/muh.jpg">
    <a style="color: #fff;" href="<?php echo base_url();?>"><b>SMK</b> MUHAMMADIYAH</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>Login/Masuk" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="nip" id="nip" placeholder="User Name">
