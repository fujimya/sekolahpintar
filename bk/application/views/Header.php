...
<head>
  ...
  <title>Data Monitoring Pelanggaran Siswa  SMK Muhammadiyah Kotaagung</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg"><b>SMK</b> Muhammadiyah</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets/HomePage/images/muh.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $user['nama']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>assets/HomePage/images/muh.jpg" class="img-circle" alt="User Image">
       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url();?>Admin/Guru"><i class="fa fa-circle-o"></i> Data Guru</a></li>
            ...
            <li><a href="<?php echo base_url();?>Pelanggaran"><i class="fa fa-circle-o"></i> Data Pelanggaran</a></li>
            <!-- <li><a href="<?php echo base_url();?>Pelanggaran/Masuk"><i class="fa fa-circle-o"></i>Pelanggaran Masuk</a></li> -->
          </ul>
        </li>
        <li> 
         <a href="<?php echo base_url();?>SiswaMelanggar"><i class="fa fa-list"></i> Data Siswa Melanggar</a>
        </li>
        <?php }?>
        <?php if($user['jabatan'] == 'guru'){ ?>
        <!--<li><a href="<?php echo base_url();?>Pelanggaran/Ajukan"><i class="fa fa-circle-o"></i>Pelanggaran</a></li>-->
        <li> 
         <a href="<?php echo base_url();?>SiswaMelanggar"><i class="fa fa-list"></i> Data Pelanggran</a>
        </li>
       <!--  <li>
